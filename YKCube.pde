...
class CubeButton {
  ...
  float x, y, size = 0;
  color def_color = color(230,230,230);
  color select_color = color(80,80,220);
  color correct_color = color(80,180,80);
  color wrong_color = color(180,80,80);
  color button_color = select_color;
  int pressLevel = 0;
  boolean first = false;
  int result = 0;
  ...
  void textConf(int align, int size, color c, boolean symbol) {
